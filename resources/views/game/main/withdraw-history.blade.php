...
<head>
    ...
    <title>Payment Withdraw History - {{ config('webdet.website_name') }}</title>
...
<body>
    <div class="game">
        <div class="title">
            <a href="/game/withdraw" style="color: white;">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h3>Payment Withdraw History</h3>
            <div>
                ...
                @php
                        try {
                            foreach ($payment as $key => $item) {
                                ...
                                echo '<td>' . $item['payment_method'] . '</td>';
                                echo '<td>' . $item['card_name'] . '</td>';
                                echo '<td>' . $item['card_no'] . '</td>';
